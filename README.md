...
Read the gatsby autogenerated docs below to build/develop or too add stuff. This can easily be deployed to netlify.
...
2.  **Open the source code and start editing!**
    ...
    Open the code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
